...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'app_project', 'address')

        # Deleting field 'Project.latitude'
        db.delete_column(u'app_project', 'latitude')

        # Deleting field 'Project.longitude'
        db.delete_column(u'app_project', 'longitude')
    ...
    models = {
        ...
        u'app.project': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'}),
