...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'app_project', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.description'
        db.delete_column(u'app_project', 'description')
