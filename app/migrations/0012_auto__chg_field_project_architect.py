...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.architect'
        db.alter_column(u'app_project', 'architect', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Project.architect'
        db.alter_column(u'app_project', 'architect', self.gf('django.db.models.fields.CharField')(max_length=200))
