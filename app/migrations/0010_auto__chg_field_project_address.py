...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_project', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=500))

    def backwards(self, orm):

        # Changing field 'Project.address'
        db.alter_column(u'app_project', 'address', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
