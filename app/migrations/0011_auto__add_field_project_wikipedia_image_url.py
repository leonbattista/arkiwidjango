...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.wikipedia_image_url'
        db.add_column(u'app_project', 'wikipedia_image_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.wikipedia_image_url'
        db.delete_column(u'app_project', 'wikipedia_image_url')
