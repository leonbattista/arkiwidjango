...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.wikipedia_page_id'
        db.add_column(u'app_project', 'wikipedia_page_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.wikipedia_page_id'
        db.delete_column(u'app_project', 'wikipedia_page_id')
    ...
    models = {
        ...
        u'app.project': {
            ...
            'architect': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            ...
            'wikipedia_image_url': ('django.db.models.fields.URLField', [], {'max_length': '500', 'blank': 'True'}),
            'wikipedia_page_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'})
        },
        u'app.tag': {
